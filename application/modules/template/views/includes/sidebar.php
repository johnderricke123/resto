        ...
        ************************************* -->
		...
		$HmvcMenu2["purchase"] = array(
			...
			"stock_out_ingredients" => array("controller" => "purchase","method" => "stock_out_ingredients","permission" => "read"),
          	"ingredients" => array("controller" => "purchase","method" => "ingredients","permission" => "read"),
		...
		$HmvcMenu2["report"] = array(
			...
			//"unpaid_sell" => array("controller" => "reports","method"     => "unpaid_sell","permission" => "read"),
...
// sidebar add stock inventory module code
              "stock_inventtory" => array("controller" => "reports","method"=> "stock_inventory","permission" => "read"),
// sidebar add stock inventory module code
...
//   			),
          ...
          //"Test" => array("controller" => "Commissionsetting","method"=> "payroll_commission","permission" => "create"),
          
          	"cancel" => array("controller" => "Commissionsetting","method" => "cancel_orders_pincodes","permission" => "read"),
          //"cancel" => array("controller" => "Cancel_pincodes","method" => "cancel_orders_pincodes","permission" => "read")
          
          //"cancel" => array("controller" => "Cancelsetting","method" => "test")
          	"activity_logs" => array("controller" => "serversetting","method" => "logs","permission" => "read"),
          	"ar_or" => array("controller" => "thirdpratycustomer","method" => "aror","permission" => "read")
		); 
		...
		$HmvcMenu2["hrm"] = array(
			...
			"ehrm" => array(
			  ...
			  /* "emp_performance" => array("controller" => "Employees","method" => "create_emp_performance","permission" => "create"),*/     
                    ...
                    <ul class="treeview-menu">  
                        <?php foreach ($moduleData as $groupLabel => $label) {?>
                            ...
                            if ((isset($label['controller']) && $label['controller']!=null) && ($label['method']!=null)) {
                               ...
                               if($this->permission->check_label($groupLabel)->access()){
								...
								//echo $label['controller']."/".$label['method'];
                            ...
                            ?> 
                                ...
                                <li class="<?php echo (($this->uri->segment(1)==$moduleName && $label['controller']==$this->uri->segment(2) && $this->uri->segment(3)==$label['method'])?"active":null) ?>">
                                    <a href="<?php echo $furl;?>">
                                      ...
                                      <?php if($groupLabel == "cancel_pin"){
                                            echo "Order Cancellation Pincode";
                                        }if($groupLabel == "stock_inventtory"){
                                            echo "Stock Inventory";
                                        }else{
                                            echo display($groupLabel);
                                        }
                                      ?>
                                  </a>
                                </li>
                       ...
                       ?>
                                <li class="<?php //echo $liclass ?>">
                                    ...
                                    <ul class="treeview-menu <?php //echo $ulclass ?>"> 
                                        <?php 
...
//HR USER ACCESS  
	...
	//if($this->session->userdata('isAdmin')) { 
      ...
      if($this->session->userdata('isAdmin') || $this->session->userdata('user_level_id') == 9) {
                // if(true) {
            ?>
...
<!--           <a href="--><?php //echo base_url('dashboard/autoupdate') ?><!--"><i class="ti-reload"></i> <span>--><?php //echo "Autoupdate";?><!--</span></a>-->
<!--        </li>-->
        <?php } ?>
        <!-- ends of admin area -->
