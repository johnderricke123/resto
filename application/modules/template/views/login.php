                    ...
                    <div class="panel-body">
                        <?php echo form_open('login','id="loginForm" novalidate'); ?>
                            <div class="form-group">
                                <label class="control-label" for="username"><?php echo display('username') ?></label>
                                <input type="text" placeholder="<?php echo display('username') ?>" name="email" id="email" class="form-control" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password"><?php echo display('password') ?></label>
                                <input type="password"  placeholder="<?php echo display('password') ?>" name="password" id="password" class="form-control" autocomplete="off"> 
                            </div>
<!--                            <div class="form-group">-->
<!--                                <label class="control-label" for="captcha">--><?php //echo $captcha_image ?><!--</label>-->
<!--                                -->
<!--                                <input type="captcha"  placeholder="--><?php //echo display('captcha') ?><!--" name="captcha" id="captcha" class="form-control" autocomplete="off"> -->
<!--                            </div> -->
                            <div> 
