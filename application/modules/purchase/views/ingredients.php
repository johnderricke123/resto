             ...
             <table width="100%" class="datatable2 table table-striped table-bordered table-hover">
                                ...
                                <tbody id="addinvoiceItem">
                                    ...
                                    <tr>
                                      ...
                                      <td>
										<?php echo number_format($details->quantity, 2); ?>
                                      </td>

                                      <td>
										<?php echo $details->curr_icon." ".number_format($details->price,2); ?>
                                      </td>
                                      <td>
										<?php echo $details->curr_icon." ".number_format($details->totalprice,2); ?>
                                      </td>
