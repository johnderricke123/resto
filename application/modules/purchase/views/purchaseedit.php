...
<td class="wt">
                                                <input type="text" name="purchase_unit_quantity[]" id="purchase_unit_quantity_1" class="form-control text-right unit_ctn_1" value="<?php echo $item->purchase_unit_quantity;?>">
                                            </td>
                                       <td class="wt">
                                                <input type="text" name="purchase_unit[]" id="purchase_unit_1" class="form-control text-right p_unit_ctn_1" readonly="" value="<?php echo $item->purchase_unit;?>">
                                            </td>
                                       <td class="wt">
