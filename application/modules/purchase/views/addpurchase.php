                    ...
                    <div class="row">
                            <div class="col-sm-7">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control datepicker" name="purchase_date" value="<?php echo date('Y-m-d');?>" id="date" required="" tabindex="2" readonly="readonly">
                                    </div>
                                    <label for="date" class="col-sm-3 col-form-label">Expiry Date </label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control datepicker" name="expire_date" value="" id="expire_date"  tabindex="2" readonly="readonly">
                                    </div>
                                </div>
                            </div>
                     ...
                     <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tbody id="addPurchaseItem">
                                   ...
                                   <input type="hidden" class="sl" value="1">
                                      ...
                                      <td class="wt">
                                                <input type="number" step="0.01" name="purchase_unit_quantity[]" id="purchase_unit_quantity_1" class="form-control text-right unit_ctn_1">
                                            </td>
                                       <td class="wt">
                                                <input  type="text" name="purchase_unit[]" id="purchase_unit_1" class="form-control text-right p_unit_ctn_1" readonly="">
                                            </td>
                                       <td class="wt">
                                            ...
                                            <td class="test">
                                                <input type="number" name="product_rate[]" onkeyup="calculate_store(1);" onchange="calculate_store(1);" id="product_rate_1" class="form-control product_rate_1 text-right" placeholder="0.00" value="" min="0" step="0.01" tabindex="7">
                                            </td>
                                           

                                            <td class="text-right">
                                                <input class="form-control total_price text-right" type="number" step="0.01" name="total_price[]" id="total_price_1" value="0.00" readonly="readonly">
                                            </td>
                                            <td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="6" style="text-align:right;"><b>Paid Amount:</b></td>
                                        <td class="text-right">
...
function product_list(sl) {
  ...
  var purchase_unit_quantity    = 'purchase_unit_quantity_'+sl;
  var purchase_unit    = 'purchase_unit_'+sl;
    ...
    var options = {
       ...
       focus: function( event, ui ) {
           ...
           //$('#'+purchase_unit_quantity).val(ui.item.unit_size);
           $('#'+purchase_unit).val(ui.item.unit);
           return false;
       },
       select: function( event, ui ) {
            ...
            var product_id    = ui.item.value;
         	var purchase_unit = ui.item.unit;
...
var count = 2;
  ...
  newdiv.innerHTML ='<td class="span3 supplier"><input type="text" name="product_name[]" required class="form-control product_name productSelection" onkeypress="product_list('+ count +');" placeholder="Item Name" id="product_name_'+ count +'" tabindex="'+tab1+'" > <input type="hidden" class="autocomplete_hidden_value product_id_'+ count +'" name="product_id[]" id="SchoolHiddenId"/>  <input type="hidden" class="sl" value="'+ count +'">  </td><td><input type="text" id="purchase_unit_quantity_'+ count +'" class="form-control text-right unit_ctn_'+ count +'" /></td><td class="wt"> <input type="text" id="purchase_unit_'+ count +'" class="form-control text-right p_unit_ctn_'+ count +'" readonly/></td><td class="wt"><input type="text" id="available_quantity_'+ count +'" class="form-control text-right stock_ctn_'+ count +'" placeholder="0.00" readonly/> </td><td class="text-right"><input type="number" step="0.01" name="product_quantity[]" tabindex="'+tab2+'" required  id="cartoon_'+ count +'" class="form-control text-right store_cal_' + count + '" onkeyup="calculate_store(' + count + ');" onchange="calculate_store(' + count + ');" placeholder="0.00" value="" min="0"/>  </td><td class="test"><input type="number" name="product_rate[]" onkeyup="calculate_store('+ count +');" onchange="calculate_store('+ count +');" id="product_rate_'+ count +'" class="form-control product_rate_'+ count +' text-right" placeholder="0.00" step="0.01" value="" min="0" tabindex="'+tab3+'"/></td><td class="text-right"><input class="form-control total_price text-right total_price_'+ count +'" type="text" name="total_price[]" id="total_price_'+ count +'" value="0.00" readonly="readonly" /> </td><td> <input type="hidden" id="total_discount_1" class="" /><input type="hidden" id="all_discount_1" class="total_discount" /><button style="text-align: right;" class="btn btn-danger red" type="button" value="Delete" onclick="deleteRow(this)" tabindex="8">Delete</button></td>';
    ...
    function calculate_store(sl) {
      ...
      // var purchase_unit = $("#purchase_unit_quantity_"+sl).val();

        //var total_price     = item_ctn_qty * purchase_unit;
