        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open_multipart('itemmanage/item_food/menutypecreate') ?>
                    <?php echo form_hidden('menutypeid', (!empty($intinfo->menutypeid)?$intinfo->menutypeid:null)) ?>
                        ...
                        <input type="file" accept="image/*" name="picture"><a class="cattooltipsimg" data-toggle="tooltip" data-placement="top" title="Use only .jpg,.jpeg,.gif and .png Images"><i class="fa fa-question-circle" aria-hidden="true"></i></a> 
                          <small id="fileHelp" class="text-muted"><img src="<?php echo base_url(!empty($intinfo->menu_icon)?$intinfo->menu_icon:'assets/img/icons/default.jpg'); ?>" id="output" style="height: 150px;width: 200px;background: rgb(0,0,0,0.4);" class="img-thumbnail"/>
</small>
