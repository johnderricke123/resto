                 ...
                 <?php endif; ?>
                        ...
                        <div class="row">
                    		...
                    		<div class="col-lg-7">
                    		  ...
                    		  <div class="form-group row">
                                    <label for="lastname" class="col-sm-6 col-form-label"><input type="checkbox" name="IsTransaction" value="1" id="IsTransaction" size="28"><label for="IsTransaction"> IsTransaction</label>
