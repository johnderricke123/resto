...
<?php
  ...
  function AssertCoa($HeadName,$HeadCode,$GL,$oResultAsset,$Visited,$value,$dtpFromDate,$dtpToDate,$check){
      ...
      $CI =& get_instance();
		 //echo $HeadName.'_'.$HeadCode.'_'.$GL.'_'.$check.'_'.$Visited.'_'.$value;
		 //print_r($oResultAsset);
		 //echo "<br>";
      if($value==1)
      { 
      ?>
            ...
            <div id="printArea">
                <div class="panel-body">
                  <table width="100%" class="table_boxnew" cellpadding="5" cellspacing="0">
                    <tr>
                        <td colspan="2" align="center" style="font-size:20px;"><b><?php echo display('statement_of_comprehensive_income')?><br/><?php echo display('from')?> <?php echo $dtpFromDate ?> <?php echo display('end_date')?> <?php echo $dtpToDate;?></b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right" style="border-left:solid 1px #000; border-bottom:solid 1px #000; border-top:solid 1px #000;"><h4><?php echo display('pflos') ?> <?php echo $TotalAssetF>$TotalLibilityF?"(Profit)":"(Loss)";?></h4></td>
