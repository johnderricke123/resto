...
<!--            </div>-->
                ...
                <div class="item-info gap_right">
                    <h5 class="item-title">
                        <?php if($ctype) {
                            ...
                            echo display('table'); ?>: <?php echo $tableinfo->tablename;
                        }?></h5>
                </div>
                <div class="item-info">
                ...
                <div class="invoice-list">
				  ...
				  $totalamount=0;
					...
					?>                
                        <div class="row-data">
                            <div class="row-data">
                                <span class="item-number" style="width: 25px;"><?php echo $item->menuqty;?></span>
                                <span class="item-title" style="width: 214px;"><?php echo $item->ProductName .' ' . $item->price;?></span>
                                
                                <span><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format($itemprice-$ptdiscount,"2",".",",");?> <?php if($currency->position==2){echo $currency->curr_icon;}?></span>
                            </div>
                        </div>
                    <?php 
			if(!empty($item->add_on_id)){
            ...
            <div class="invoice-footer mb-15">
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format($billinfo->total_amount,"2",".",",");?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <div class="row-data">
                    <div class="item-info">
			...
			if($billinfo->bill_status==1){?>
                <div class="row-data">
                    ...
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo number_format($customepaid,"2",".",","); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
                <?php } else{ ?>
                <div class="row-data">
                    <div class="item-info">
            ...
            <div class="row-data">
                <div class="col-md-12 item-info">
                    <h5 class="item-title"><?php echo display('billing_to');?>: <?php echo $customerinfo->customer_name;?>  <?php echo $hotel;?></h5>
                </div>
                <div class="col-md-12">
            ...
            <div class="row-data">
                <span><?php echo display('date');?>: <?php echo date("M d, Y", strtotime($orderinfo->order_date));?></span>
                <span class="my-5">TXN#<?php echo $orderinfo->order_id;?></span>
            </div>
