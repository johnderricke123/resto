                                    ...
                                    if(!empty($item->add_on_id) && !empty($isaddones) ){
                                     ...
                                     $y++;
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><b><?php echo number_format($totalprice,3);?> </b></td>
                                        </tr>
                                         <tr>
                                            <td colspan="1" align="right" style="text-align:right;font-size:14px !Important">&nbsp; <b><?php echo display('vat_tax') ?> </b></td>
                                            <td style="text-align: right;"><b><?php echo number_format($totalvat,3);?></b></td>
                                        </tr>
                                         <tr>
                                            <td colspan="1" align="right" style="text-align:right;font-size:14px !Important">&nbsp; <b><?php echo display('service_chrg') ?> </b></td>
                                            <td style="text-align: right;"><b><?php echo number_format($service_chrg_data,3);?></b></td>
                                        </tr>
                                         <tr>
