       ...
       <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <label for="4digit" class="col-form-label pb-2"><?php echo display('cuspayment');?></label>
                                  ...
                                  <input type="number"  class="form-control number" id="paidamount_marge[]" name="paidamount[]" value="0"  placeholder="0" onkeyup="changedueamount()" onfocus="givefocus(this)" />
                          
                        </div>
                      </div>
                      <div class="row no-gutters">

                             <div class="cardarea" style="display:none; width:100%;" >
                        <div class="form-group col-md-6">
