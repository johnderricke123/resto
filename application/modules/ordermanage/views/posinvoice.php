...
<div class="page-wrapper" style="width: auto;">
...
<!--            </div>-->
            <div class="invoice-head">
                <div class="middle-data">
                    <div class="item-info text-center">
                        <h4 class="text-center">DCCCO HOTEL <br> Sales Invoice</h4>
                    </div>
                </div>
                <div class="middle-data gap_right">
            ...
            <div class="invoice-details">
                <div class="invoice-list">
                    <div class="invoice-title" style="justify-content: space-around;">
                      ...
                      <h4 class="heading"><?php echo display('price')?></h4>
                        <h4 class="headingd"><?php echo display('total')?></h4>
                    </div>
				  ...
				  $totalamount=0;
					...
					?>                
                        <div class="row-data">
                            <div class="item-info">
                              <p class="item-title"><span class="item-list"><?php echo $item->ProductName;?></span> - <?php echo $item->variantName;?>
                              <span class="item-number" ><?php echo $item->menuqty;?> x <?php echo $item->price; ?></span></p>
                            </div>
                          <?php $itemprice = $itemprice-$ptdiscount ; ?>
                          
                          
                            <h5><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format($itemprice, 2, '.', ''); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                        </div>
                    <?php 
			if(!empty($item->add_on_id)){
				$y=0;
			...
			if($billinfo->bill_status==1){?>                
                        <?php 
                                         if($p_method) {
                                            ...
                                            foreach($p_method as $pmethod)       {           ?>
                      <div class="row-data">		
                      						<div class="item-info">
                                              <h5 class="item-title">           
                          							<?php echo $pmethod['method'] .'</h5></div><h5 class="my-5">  - '.number_format($pmethod['amount'], 2,'.','') . '</h5></div>';
                                              $i++;
                                                          }
            ...
            <div class="invoice_address">
              <?php if($orderinfo->customer_name){?>
                    <div class="row-data">
              		...
              		<div class="item-info">
                        <h5 class="item-title"><?php echo $customerinfo->customer_name;?></h5>
                    </div>
                    <div class="row-data">
                        <div class="item-info">
                          ...
                          <?php $rm = explode("|", $orderinfo->customer_note);?>
                            ...
                            <h5><?php echo $rm[2]; ?>  Booking ID:<?php echo $rm[1]; ?></h5>                          
                          <h5>
