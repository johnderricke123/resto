                ...
                <div class="panel-body">
					...
					<div class="row bg-brown">
                             <div class="col-sm-12 kitchen-tab" id="option">
                                                ...
                                                <input id="chkbox-1763" type="checkbox" class="individual" name="tablemaping" value="tablemaping" <?php if($possetting->tablemaping==1){ echo "checked";}?>>
                                                <label for="chkbox-1763" style="display:inline-flex">
                                                    <span class="radio-shape">
                                                        <i class="fa fa-check"></i>
                                                    </span>
