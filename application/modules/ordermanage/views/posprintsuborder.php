...
<div class="page-wrapper" id="printableArea">
        <div class="invoice-card d-none">
            
          <div class="text-center">
                    <h3 class="mt-10">DCCCO HOTEL <br> Invoice</h3>
            <p>
            <nobr><?php echo display('date');?>: <?php echo date('M d, Y');?></nobr>
            </p>
                </div>
          <div class="middle-data">
					...
					?>                
                        <div class="row-data">
                            <div class="item-info">
                                ...
                                <p class="item-size"><?php echo $item->variantName;?> - <?php echo $item->menuqty;?> x <?php echo number_format($item->price,2);?></p>
                            </div>
				...
				$y=0;
					foreach($addons as $addonsid){
                        ...
                        <div class="row-data">
                            ...
                            <h5><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php $item_price = $adonsinfo->price*$addonsqty[$y];
                      										echo number_format($item_price, 2); ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                        </div>
                    <?php $y++;
						}
				 }
            ...
            <div class="invoice-footer mb-15">
                ...
                <div class="row-data" style="border-top: 1px solid #000;">
                    ...
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format($gtotal, 2);?> <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
            </div>
                    ...
                    <div class="row-data">
                        <div class="item-info">
                          <?php 
                                                       ...
                                                       echo $customerinfo->customer_note;?>
                            <h5>Room # ________ ID#________________</h5>
