                ...
                <div class="panel-body">
                             ...
                             <div class="col-sm-12" id="cartlist">
                               ...
                               <div class="table-wrapper-scroll-y">
                                ...
                                <?php $i=0; 
									...
									?>
                                    <tr>
                                        <td class="text-left" align="left" style="text-align: left;">
                                     	<?php echo $item['name'];
										if(!empty($item['addonsid'])){
											echo "<br>";
                                        ...
                                        <td class="text-right"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format($item['price'], 2,'.','') ;?> <?php if($currency->position==2){echo $currency->curr_icon;}?> 
                                        <?php 
										if(!empty($item['addonsid'])){
											echo "<br>";
										...
										if(!empty($item['addonsid'])){
											echo "<br>";
											echo number_format($item['addonsqty'],2,'.','');
											}
										?>
                                        </td>
                                        ...
                                        <strong><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format($itemprice, 2,'.');?> <?php if($currency->position==2){echo $currency->curr_icon;}?> </strong>&nbsp;&nbsp;
                    ...
                    <div class="row">
						...
						echo form_dropdown('tableid',$tablelist,(!empty($tablelist->tableid)?$tablelist->tableid:null),'class="form-control" id="tableid" required') ?>
                                ...
                                <div class="form-group row" id="default_customer_name">
                               ...
                               <div class="col-sm-3">
                               <a href="#" class="client-add-btn" aria-hidden="true" data-toggle="modal" data-target="#client-info" style="position:relative;"><i class="ti-plus m-r-2"></i>New Customer </a>
                               </div>
                            </div>

                             <div class="col-md-6 form-group" id="active_hotel_customer">
                                 <label for="customer_name">Active Hotel Guest<span class="color-red">*</span></label>
                                 <div class="d-flex">
                                     <?php  $cusid=1;
                                     echo form_dropdown('customer_name',$active_hotel_customer,(!empty($cusid)?$cusid:null),'class="postform resizeselect form-control" id="customer_name" required') ?>
                                 </div>
                             </div>
                            ...
                            <fieldset class="border p-2">
                               <legend class="w-auto">Payment Information</legend>
                            		...
                            		<div class="col-sm-7">
                                		...
                                		<div class="form-group row" id="cholder" style="display:none;">
                                    ...
                                    <div class="col-sm-5" style="display:none;" id="cnumber">
                                    <div class="form-group row">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                    	<div class="form-group row" style="margin-bottom:0px;">
                                            ...
                                            onkeyup="calculatetotal();"  class="form-control text-right" name="service_charge" placeholder ="0.00" style="margin-bottom:5px;" /></div></div>
