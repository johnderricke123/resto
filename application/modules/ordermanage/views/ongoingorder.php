    ...
    <div class="hero-widget well well-sm" style="height:auto !important">
            <p style="margin:0;">
                ...
                <small class="pull-right">
                    <a href="<?php echo base_url("ordermanage/order/updateorder/".$onprocess->order_id) ?>" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update Order"><i class="fa fa-pencil"></i></a>
                </small>
            </p>
            <p style="margin:0;">
            ...
            <a href="javascript:;" onclick="payorderbill(4,<?php echo $onprocess->order_id;?>,'<?php echo $billtotal;?>')" class="btn btn-xs btn-success btn-sm mr-1">
                <?php echo display('cmplt');?></a>&nbsp;
        ...
        <a href="javascript:;" onclick="payorderbill(10,<?php echo $onprocess->order_id;?>,'<?php echo $billtotal;?>')" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="" data-original-title="Add Payment"><i class="fa fa-window-maximize"></i>
        </a>&nbsp;<?php if($ispaid==0){?><a onclick="pospageprintdue(<?php echo $onprocess->order_id;?>)" class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title="" data-original-title="Bill Out"><i class="fa fa-window-restore"></i></a><?php } ?>
    </div>
</div>
 <?php }
 }
