...
<table class="table table-fixed table-bordered table-hover bg-white" id="purchaseTable">
                                <thead>
                                     <tr>
                                            ...
                                            <th class="text-center" style="width:70px;"><?php echo display('qty')?></th> 
                                ...
                                <?php $i=0; 
                                    ...
                                    <tr>
										...
										?>
                                         ...
                                         <td class="text-right"><a class="btn btn-info btn-sm btnleftalign" onclick="updatecart('<?php echo $item['rowid']?>',<?php echo number_format($item['qty'],2,'.','');?>,'add')"><i class="fa fa-plus" aria-hidden="true"></i></a>&nbsp;
                                        ...
                                        <a class="btn btn-danger btn-sm btnrightalign" onclick="updatecart('<?php echo $item['rowid']?>',<?php echo number_format($item['qty'], 2,'.','');?>,'del')"><i class="fa fa-minus" aria-hidden="true"></i></a>
                                        </td>
                                     </tr>
                                    <?php } 
