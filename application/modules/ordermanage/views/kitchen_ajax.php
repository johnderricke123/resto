...
<!--            <div class="food_item --><?php //if($orderinfo->order_status!=3){ echo "pending";}?><!--" style="position:relative;">-->
          <div class="food_item" style="position:relative;">
            <div class="food_item_top">
              <div class="item_inner">
                <h4 class="kf_info"><?php echo $orderinfo->tablename;?></h4>
                </div>
              <div class="item_inner">
                <h4 class="kf_info">Waiter: <?php echo $orderinfo->first_name.' '.$orderinfo->last_name;?></h4>
              </div>
              <div class="item_inner">
<!--                <h4 class="kf_info">--><?php //echo display('tok') ?><!--: --><?php //echo $orderinfo->tokenno;?><!--</h4>-->
            ...
            <div class="circle-openk" id="circlek<?php echo $orderinfo->order_id;?>" onclick="showhide(<?php echo $orderinfo->order_id;?>)">
                <i class="fa fa-caret-down arrow-kitchen thisrotate<?php echo $orderinfo->order_id;?> rotate"></i>
            </div>
