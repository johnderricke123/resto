...
//$('#item-number').text(totalitem.toFixed(0));
//$("#getitemp").val(totalitem.toFixed(0));
//FIXED BUG: NOT ADDING OR SUBTRACTING IN GRAND TOTAL WHEN PLUS AND MINUS BUTTONS IS CLICKED
...
function posaddonsfoodtocart(pid,id,more=null){
  ...
  var adonsname=[];
        $('input[name="addons"]:checked').each(function() {
          var adnsid=$(this).val();
          var adsqty=$('#addonqty_'+adnsid).val();
          adonsqty.push(adsqty.toFixed(0));
            addons.push($(this).val());
  ...
  var itemname=$("#itemname_"+id).val();
   ...
   if(typeof updateid == "undefined"){
     ...
     var geturl=$("#carturl").val();
     var myurl =geturl;
  var dataString = "pid="+pid+'&itemname='+itemname+'&varientname='+varientname+'&qty='+qty+'&price='+price+'&catid='+catid+'&sizeid='+sizeid+'&addonsid='+addons+'&allprice='+allprice+'&adonsunitprice='+adonsprice+'&adonsqty='+adonsqty+'&adonsname='+adonsname+'&isgroup='+isgroup+'&totalvarient='+totalvarient+'&customqty='+customqty;
   }
   else{
   /*check production*/
                var productionsetting = $('#production_setting').val();
     ...
     var geturl=$("#updatecarturl").val();
     var myurl =geturl;
     var dataString = "pid="+pid+'&itemname='+itemname+'&varientname='+varientname+'&qty='+qty+'&price='+price+'&catid='+catid+'&sizeid='+sizeid+'&addonsid='+addons+'&allprice='+allprice+'&adonsunitprice='+adonsprice+'&adonsqty='+adonsqty+'&adonsname='+adonsname+'&orderid='+updateid+'&isgroup='+isgroup+'&totalvarient='+totalvarient+'&customqty='+customqty;
     }
    $.ajax({
        type: "POST",
       url: myurl,
  ...
  function getAjaxModal(url,callback=false,ajaxclass='#modal-ajaxview',modalclass='#payprint_marge',data='',method='get')
    ...
    $.ajax({
     ...
     function checkproduction(foodid,vid,servingqty){
        ...
        var dataString = "foodid="+foodid+'&vid='+vid+'&qty='+servingqty;
