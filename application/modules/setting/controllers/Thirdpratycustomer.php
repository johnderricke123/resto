...
class Thirdpratycustomer extends MX_Controller {
    ...
    public function index($id = null)
    {
        ...
        $data['title']    = 'Third Party Customers List'; //display('3rd_customer_list');
        #-------------------------------#       
        #
        #pagination starts
        #
  ...
  function aror(){
	...
	$data['ar_or'] = $this->thirdpartycustomer_model->get_ar_or($start_date, $end_date); 

    
      	$data['title']  = display('ar_or');
        $data['module'] = "setting";  
        $data['page']   = "aror_settings";  
        echo Modules::run('template/layout', $data); 
	}
