...
class Setting extends MX_Controller {
	...
	public function create()
	{
      ...
      //var_dump($this->input->post());die();
		...
		$this->form_validation->set_rules('email',display('email'),'max_length[100]');
		...
		$data['setting'] = (object)$postData = array(
			...
			'storename'   => $this->input->post('stname'),
			...
			'vat'	      => $this->input->post('storevat'),
			'isvatnumshow'=> $this->input->post('isvatnumber'),
			'vattinno'	  => $this->input->post('vatnumber'),
			'discount_type'	=> $this->input->post('dtype'),
			'servicecharge'	=> $this->input->post('scharge'),
			'service_chargeType'	=> $this->input->post('sdtype'),
			'currency'	  => $this->input->post('currency'),
			'min_prepare_time'	=> $this->input->post('delivary_time'),
			'language'    => $this->input->post('language'),
			'dateformat' => $this->input->post('timeformat'),
