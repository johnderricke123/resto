...
class Ingradient extends MX_Controller {
    ...
    public function index($id = null)
    {
        ...
        $data['purchase_unit_dropdown']   =  $this->unit_model->purchase_unit_dropdown();
        #
        #pagination ends
        #   
        $data['module'] = "setting";
    ...
    //  $this->form_validation->set_rules('purchase_unit_id',display('unit_name')  ,'required');
	  ...
	  $data['units']   = (Object) $postData = [
       ...
       'qty_unit' 	 		 => $this->input->post('qty_unit',true),
       'purchase_unit_id' 	 => $this->input->post('purchase_unit_id',true),
   ...
   public function updateintfrm($id){
		...
		$data['unitdropdown']   =  $this->unit_model->ingredient_dropdown();
     	$data['punitdropdown']   =  $this->unit_model->purchase_unit_dropdown();
         $data['module'] = "setting";  
