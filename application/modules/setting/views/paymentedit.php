                    ...
                    <?php echo form_hidden('payment_method_id', (!empty($intinfo->payment_method_id)?$intinfo->payment_method_id:null)) ?>
                        <div class="form-group row">
                  		...
                  		<div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                 <input name="debit_acct" class="form-control" type="text" placeholder="Debit Acct" id="debit" value="<?php echo (!empty($intinfo->debit_acct)?$intinfo->debit_acct:null) ?>">
                            </div>
                        </div> 
                   		<div class="form-group row">
                            <label for="payment" class="col-sm-4 col-form-label">Credit Acct</label>
                            <div class="col-sm-8">
                                 <input name="credit_acct" class="form-control" type="text" placeholder="Credit Acct" id="credit" value="<?php echo (!empty($intinfo->credit_acct)?$intinfo->credit_acct:null) ?>">
                            </div>
                        </div> 
