        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('setting/ingradient/create') ?>
                    <?php echo form_hidden('id', (!empty($intinfo->id)?$intinfo->id:null)) ?>
                  		...
                  		<div class="form-group row">
                       	<label for="lastname" class="col-sm-5 col-form-label">Purchase Unit *</label>
                              ...
                              <?php 
                              if(empty($categories)){$categories = array('' => '--Select--');}
                              echo form_dropdown('purchase_unit_id',$unitdropdown,(!empty($intinfo->id)?$intinfo->id:null),'class="form-control"') ?>
                              </div>
                    	</div>
                  		<div class="form-group row">
                              <label for="lastname" class="col-sm-5 col-form-label">Pkg. Unit </label>
                               <div class="col-sm-6">
                                <input name="qty_unit" class="form-control" type="number" min="1" max="1000000"  step="any" id="qty_unit"  value="">
                            </div>
                  		</div>
                        <div class="form-group row">
                        ...
                        <?php if (!empty($ingredientlist)) { ?>
                            ...
                            <?php foreach ($ingredientlist as $ingredient) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                  ...
                                  <td><?php if($ingredient->qty_unit > 0) echo $ingredient->qty_unit; ?></td>
                                  <td><?php if($ingredient->purchase_unit_id > 0) echo $ingredient->p_unit_name; ?></td>                                   
