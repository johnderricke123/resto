...
<!--<button type="button" class="btn btn-primary btn-md" data-target="#add1" data-toggle="modal"  ><i class="fa fa-plus-circle" aria-hidden="true"></i>
<?php //echo display('bulk_upload')?></button>-->
<?php endif; ?>

</div>
<form action="<?php echo base_url("setting/customerlist/insert_customer") ?>" class="form-vertical" id="validate" method="post" accept-charset="utf-8">
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                 ...
                                 <!--    <td><?php echo $customer->customer_address; ?></td>  -->
                                    ...
                                    <input name="url" type="hidden" id="url_<?php echo $customer->customer_id; ?>" value="<?php echo base_url("setting/customerlist/updateintfrm") ?>" />
                                        ...
                                        <a href="<?php echo base_url("setting/customerlist/customerDelete/$customer->customer_id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
                                         <?php endif; ?> 
                                       
<!-- modal button -->                                       <!-- Button trigger modal -->
