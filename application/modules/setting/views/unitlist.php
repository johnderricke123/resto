        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('setting/unitmeasurement/create') ?>
                    <?php echo form_hidden('id', (!empty($unitinfo->id)?$unitinfo->id:null)) ?>
                        <div class="form-group row">
                            <label for="unit_name" class="col-sm-4 col-form-label"><?php echo display('unit_name') ?> *</label>
                            <div class="col-sm-8">
                  		...
                  		<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="sale_qty" class="form-control" type="text" placeholder="1000" id="ingredient_unitname" value="">
                            </div>
                          <div class="col-sm-4">
                              <input name="sale_unit" class="form-control" type="text" id="sale_unit" value="" placeholder="mg,gm,ml">
                                <?php 
                        ...
                        <div class="form-group row">
                            <label for="unit_short_name" class="col-sm-4 col-form-label">Purchase Unit</label>
                            <div class="col-sm-8">
                        ...
                        <?php if (!empty($unitlist)) { ?>
                            ...
                            <?php foreach ($unitlist as $unit) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php echo $unit->sale_unit; ?></td>
                                    <td><?php echo $unit->sale_qty; ?></td>
                                   <td class="center">
