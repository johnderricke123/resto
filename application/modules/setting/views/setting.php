				...
				echo form_open_multipart('setting/setting/create','class="form-inner"') ?>
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <label for="vatnumber" class="col-xs-2 col-form-label"><?php echo "VAT/TIN Number"; ?></label>
                        <div class="col-xs-3">
                            <input name="vatnumber" type="text" class="form-control" id="vatnumber" placeholder="<?php echo "VAT/TIN Number"; ?>"  value="<?php echo $setting->vattinno ?>" >
                        </div>
                         <label for="isvatnumber" class="col-xs-2 col-form-label"><?php echo "Show/Hide(VAT/TIN)"; ?></label>
                        <div class="col-xs-1">
                    ...
                    <div class="form-group row">
              		...
              		<div class="form-group row">
                       <label class="col-xs-3 col-form-label">Change Cancel Password</label>
                      	<div class="col-xs-9">
