...
class Ingradient_model extends CI_Model {
	...
	{
	    $this->db->select('ingredients.*, unit_of_measurement.uom_name, pum.uom_name as p_unit_name');
        $this->db->from($this->table);
		$this->db->join('unit_of_measurement','ingredients.uom_id = unit_of_measurement.id','left');
       // $this->db->join('unit_of_measurement as pum','ingredients.purchase_unit_id = unit_of_measurement.id','left');
        $this->db->join('unit_of_measurement as pum', 'ingredients.purchase_unit_id = pum.id', 'left');
