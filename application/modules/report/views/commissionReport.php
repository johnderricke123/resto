...
function getreport(){
	...
	var myurl =baseurl+'report/reports/<?php echo $view;?>';
	    var dataString = "from_date="+from_date+'&to_date='+to_date+'&table_id='+table_id;;
		 $.ajax({
		 type: "POST",
		 url: myurl,
		 data: dataString,
		        ...
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		               ...
		               $statdate = date('d-m-Y', strtotime('first day of this month'));?>
		                    ...
		                    <?php }?>
		                  <!--   <div class="form-group">
                            	 <label class="" for="orderid"><?php echo $table_details;?></label>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var myurl =baseurl+'report/reports/<?php echo $view;?>';
		var table_id = $('#table_id').val();
	    var dataString = 'from_date=<?php echo $statdate?>&to_date=<?php echo $today?>'+'&table_id='+table_id;
		 $.ajax({
		 type: "POST",
		 url: myurl,
		 data: dataString,
