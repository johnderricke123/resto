			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
						...
						<?php date_default_timezone_set("Asia/Manila"); $today = date('d-m-Y'); ?>
		            ...
		            <div class="panel-body">
						<div id="printableArea" style="margin-left:2px;">
							<div class="text-center">
								...
								<h4> <?php echo "Print Date" ?>: <?php echo date("M d, Y h:i a"); ?> </h4>
							</div>
			                <div class="table-responsive" style="margin-top: 10px;" id="stockproduct">
                            <table id="respritbl" style="width:100%;" class="table table-bordered table-striped table-hover">
			                        <thead>
										<tr>
