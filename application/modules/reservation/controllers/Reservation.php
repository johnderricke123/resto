...
class Reservation extends MX_Controller {
	...
	public function reservationform(){
      ...
      $data['customerNamesDrop']   = $this->reservation_model->customer_name_dropdown_select();
      //var_dump($data['customerNamesDrop']);die();
      
      //var_dump($data['customerlist']);die();
        $data['module'] = "reservation";  
    ...
    {
      //var_dump(number_format($this->input->post('down_payment'), 2));die();
      //var_dump("Mariele");die();
//var_dump($this->input->post());die();
    //var_dump($this->input->post('event_name',true));die();
	//print_r($this->input->post()); die();
      ...
      //print_r($this->input->post()); die();
      //var_dump($this->input->post('tableid',true));die();
...
/*        
        ...
        'corkage' 		 	 => $this->input->post('corkage',true),
        'meal' 		 		 => $this->input->post('meal',true),
        'notes' 		 	 => $this->input->post('notes',true),
        'down_payment' 		 => number_format($this->input->post('down_payment',true), 2),
        'ar_or' 		 => $this->input->post('ar_or',true),
        'grand_total' 		 => number_format($this->input->post('grand_total',true), 2),
...
//var_dump($customerData);die();         
	  $mobile=$this->input->post('mobile',true);
         ...
         //original code
	         //$rerturnid=$this->reservation_model->insertcustomertoDB($customerData,$mobile);
         //original code
         ...
         //newly added
           if(!$customer_id){
             ...
             $rerturnid = $customer_id;
           }
         //newly added  
         
	  
         
//var_dump($rerturnid);die();         
    //var_dump($rerturnid);die();
...
//newly added
        ...
        'meal' 		 		 => $this->input->post('meal',true),
        'notes' 		 	 => $this->input->post('notes',true),
	    //number_format($this->input->post('down_payment'), 2, '.', ','),
        'down_payment' 		 => number_format($this->input->post('down_payment',true), 2),
        'ar_or' 		 => $this->input->post('ar_or',true),
        'grand_total' 		 => number_format($this->input->post('grand_total',true), 2),
        'customer_phone'       => $this->input->post('mobile',true),
...
//newly added
     //$data['TblReserveInfo']   = $this->reservation_model->findByTblReserve($data['intinfo']->cid);
     $data['TblReserveInfo']   = $this->reservation_model->findByTblReserve($id);
//newly added
     //var_dump($data['TblReserveInfo']);die();
	...
	public function checkavailablity(){
      ...
      //var_dump($this->reservation_model->checkfree($gettable,$numofpeople));die();
