...
class Production extends MX_Controller {
	...
	public function productionitem(){
		...
		foreach ($product_info as $value) {
			$json_product[] = array('label'=>$value['ingredient_name'],'value'=>$value['id'],'uprice'=>$value['utotalprice']/$value['uquantity'],'unit'=>$value['m_unit'], 'p_unit'=>$value['p_unit'], 'uquantity'=>$value['uquantity'],'qty_unit'=>$value['qty_unit']);
		} 
  ...
  public function getlist($id){
    ...
    public function delete($id = null)
    {
  	...
  	public function delete_production_list($id,$qid)
    {
        $this->permission->module('production','delete')->redirect();
		$logData = array(
	   'action_page'         => "production List",
	  ...
	  $result = $this->production_model->delete_production($id,$qid);
