                ...
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Cost <?php echo display('price') ?></th>
                    ...
                    <tbody>
                       ...
                       ?>
                            <?php foreach ($productionlist as $items) { 
                      				 $total_cost = $total_cost + $items->total_price;
                      ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo $items->ProductName; ?></td>
                                    <td><?php echo $items->variantName; ?></td>
                                    <td><?php echo number_format((float)$items->total_p_amt,2); ?></td>
                                   <td class="center">
                                    ...
                                    <?php if($this->permission->method('production','update')->access()): ?>
                                     ...
                                     <a href="<?php echo base_url('production/production/delete_production_list/'.$items->foodid.'/'.$items->pvarientid); ?>" class="btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="Delete" onclick="return confirm('Are you sure?')"><i class="fa fa-close" aria-hidden="true"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
