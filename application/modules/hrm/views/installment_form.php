...
<a href="<?php echo base_url();?>hrm/Loan/installmentView" class="btn btn-primary"><?php echo display('manage_installment')?></a>
<?php endif; ?>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Loan/create_installment') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1" name="installment_amount" class="form-control" placeholder="<?php 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="payment" min="1" class="form-control" type="number" placeholder="<?php echo display('payment') ?>" id="payment">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1" name="installment_no" class="form-control"  placeholder="<?php echo display('installment_no') ?>" id="installment_no" value="1" >
                            </div>
                        </div>
...
function SelectToLoad(id){
    ...
    $.ajax({
        url : "<?php echo site_url('hrm/Loan/select_to_load/')?>",
        method:'post',
       dataType:'json',
      data:{
            'employee_id':id,
...
function SelectToname(id){
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('hrm/Loan/select_to_install/')?>" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function SelectAuto(id){
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('hrm/Loan/select_to_autoincrement/')?>" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
