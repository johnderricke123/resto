   <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                 <?= form_open('hrm/Loan/update_install_form/'. $data->loan_inst_id) ?>
        ...
        ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="payment" min="1" class="form-control" type="number" placeholder="<?php echo display('payment') ?>" id="payment" value="<?php echo $data->payment; ?>">
                            </div>
                        </div>
        ...
        ?>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1" name="installment_no" class="form-control"  placeholder="<?php echo display('installment_no') ?>" id="installment_no" value="<?php echo $data->installment_no; ?>" >
                            </div>
                        </div>
