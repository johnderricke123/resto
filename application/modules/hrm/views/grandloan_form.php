...
<a href="<?php echo base_url();?>hrm/Loan/loan_view" class="btn btn-primary"><?php echo display('manage_granted_loan')?></a>
<?php endif; ?>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Loan/create_grandloan') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="amount" min="1" class="form-control" type="number" placeholder="<?php echo display('amount') ?>" id="amount">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1" name="interest_rate" class="form-control"  placeholder="<?php echo display('interest_rate') ?>" id="interest_rate" >
                            </div>
                        </div>
