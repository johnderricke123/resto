        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                      ...
                      <?= form_open_multipart('hrm/Leave/update_application_form/'. $data->leave_appl_id) ?>
                    ...
                    <input name="leave_appl_id" type="hidden" value="<?php echo $data->leave_appl_id ?>">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="apply_strt_date" class="datepickerjs form-control apply_start" id="apply_start" placeholder="<?php echo display('apply_strt_date') ?>" value="<?php echo $data->apply_strt_date ?>">
                            </div>
                             <label for="apply_end_date" class="col-sm-2 col-form-label">
                            <?php echo display('apply_end_date') ?></label>
                            <div class="col-sm-4">
                           <input type="text" name="apply_end_date" class="datepickerjs form-control apply_end" id="apply_end" value="<?php echo $data->apply_end_date ?>" placeholder="<?php echo display('apply_end_date') ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="leave_aprv_strt_date" class="datepickerjs form-control leave_aprv_strt_date" value="<?php echo $data->leave_aprv_strt_date ?>" id="leave_aprv_strt_date" placeholder="<?php echo display('leave_aprv_strt_date') ?>">
                               
                            </div>
                             <label for="leave_aprv_end_date" class="col-sm-2 col-form-label">
                            <?php echo display('leave_aprv_end_date') ?></label>
                            <div class="col-sm-4">
                           <input type="text" name="leave_aprv_end_date" class="datepickerjs form-control leave_aprv_end_date" value="<?php echo $data->leave_aprv_end_date ?>" id="leave_aprv_end_date" placeholder="<?php echo display('leave_aprv_end_date') ?>">
