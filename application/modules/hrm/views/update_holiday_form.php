    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-bd lobidrag">
                ...
                <?= form_open('hrm/Leave/update_holiday_form/'. $data->payrl_holi_id) ?>
                    ...
                    <input name="payrl_holi_id" type="hidden" value="<?php echo $data->payrl_holi_id ?>">
                       ...
                       <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1" name="no_of_days" class="form-control" id="no_of_days" value="<?php echo $data->no_of_days?>">
                            </div>
                        </div> 
