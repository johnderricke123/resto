...
.nav.nav-tabs li (.active) a{
 ...
 <?= form_open_multipart('hrm/Candidate/caninfo_create') ?>
<div class="tab-content">
 ...
 <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="phone" min="0" class="form-control" type="number" placeholder="<?php echo display('phone') ?>" id="phone"  required>
                            </div>
                        </div>
                         <div class="form-group row">
                            <label for="alter_phone" class="col-sm-3 col-form-label"><?php echo display('alter_phone') ?> </label>
                            <div class="col-sm-9">
                                <input name="alter_phone" min="0" class="form-control" type="number" placeholder="<?php echo display('alter_phone') ?>" id="alter_phone">
                            </div>
                        </div>
                         <div class="form-group row">
