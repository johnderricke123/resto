        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                 <?= form_open('hrm/Loan/update_grnloan_form/'. $data->loan_id) ?>
                    ...
                    <input name="loan_id" type="hidden" value="<?php echo $data->loan_id ?>">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="amount" min="1" class="form-control" type="number" placeholder="<?php echo display('amount') ?>" id="amount"  value="<?php echo $data->amount ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1" name="interest_rate" class="form-control"  placeholder="<?php echo display('interest_rate') ?>" id="interest_rate"   value="<?php echo $data->interest_rate ?>">
                            </div>
                        </div>
