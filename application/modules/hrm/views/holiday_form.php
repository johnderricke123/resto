...
<a href="<?php echo base_url();?>hrm/Leave/manage_holiday" class="btn btn-primary"><?php echo display('manage_holiday')?></a>
<?php endif; ?>
</div>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('hrm/Leave/create_holiday') ?>
                       ...
                       echo display('holiday_name') ?>"  id="holiday_name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="no_of_days" min="1" class="form-control" type="number" placeholder="<?php echo display('no_of_days') ?>" id="no_of_days" >
                            </div>
                        </div>
