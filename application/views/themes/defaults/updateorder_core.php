...
function addextra(pid,vid,id,orderid) {
    ...
    if (!isNaN(sstid)) {
        result.value++;
	     ...
	     var myurl ='<?php echo base_url();?>hungry/updateorder/';
		 var dataString = "pid="+pid+'&itemname='+itemname+'&varientname='+varientname+'&qty='+qty+'&price='+price+'&catid='+catid+'&sizeid='+sizeid+'&orderid='+orderid+'&Udstatus='+reduce;
		 $.ajax({
		 	 type: "POST",
			 url: myurl,
			 data: dataString,
...
function addonsitemqr(id,sid,type,orderid){
		 var myurl='<?php echo base_url();?>hungry/addonsitemqr2/'+id;
		 var dataString = "pid="+id+"&sid="+sid+'&type='+type+'&orderid='+orderid;
		  $.ajax({
		 	 type: "POST",
			 url: myurl,
			 data: dataString,
...
function addextra2(pid,id,type,orderid){
	...
	var adonsqty=[];
	 ...
	 var myurl ='<?php echo base_url();?>hungry/updateorder/';
	 var dataString = "pid="+pid+'&itemname='+itemname+'&varientname='+varientname+'&qty='+qty+'&price='+price+'&catid='+catid+'&sizeid='+sizeid+'&addonsid='+addons+'&allprice='+allprice+'&adonsunitprice='+adonsprice+'&adonsqty='+adonsqty+'&adonsname='+adonsname+'&orderid='+orderid;
		$.ajax({
		 	 type: "POST",
			 url: myurl,
			 data: dataString,
