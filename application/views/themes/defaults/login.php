            ...
            <div class="row p-4">
                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="control-label" for="user_email">Email/Username</label>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <a style="cursor:pointer; color:#FFF;" class="btn btn-success btn-sm search" onclick="logincustomer();">Login</a>&nbsp; OR &nbsp;<a href="<?php echo base_url().'hungry/signup'?>" class="btn btn-success btn-sm search">Register</a><?php $facrbooklogn = $this->db->where('directory','facebooklogin')->where('status',1)->get('module')->num_rows();
                                           if($facrbooklogn == 1){
                                            ?>&nbsp; OR &nbsp;
