                <?= form_open('hungry/bookreservation',array('id'=>'reservesubmit')) ?>
                    ...
                    function submitreserve(){
						...
						var dataString = "email="+mail;
						 var actionurl ='<?php echo base_url();?>hungry/checkemailisexits';
							 $.ajax({
								 type: "POST",
								 url: actionurl,
								 data: dataString,
								 success: function(data) {
									var err = data;
										if(err=='404'){
											...
											window.location.href= '<?php echo base_url();?>mylogin';
											}						   
										else{
