                ...
                <?php if(empty($this->session->userdata('CusUserID'))){?>
                    ...
                    <div class="billing-form mt-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                            	<div class="form-group">
                                    <label class="control-label" for="district">State <abbr class="required" title="required">*</abbr></label>
                        ...
                        <div class="collapse" id="billind-different-address">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                	<div class="form-group">
                                        <label class="control-label" for="district2">State <abbr class="required" title="required">*</abbr></label>
