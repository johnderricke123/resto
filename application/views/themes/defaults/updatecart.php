...
if(!empty($this->cart->contents())){ $totalqty= count($this->cart->contents());} ;?>
            ...
            <form action="<?php echo base_url();?>hungry/updateqrorder" method="post" class="order_form">
...
<input class="btn btn-success btn-block" style="border:none;" name="" type="submit" value="<?php echo display('update_ord') ?>" />
</div>
</div>
</div>
</div>
