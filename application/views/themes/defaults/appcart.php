...
if(!empty($this->cart->contents())){ $totalqty= count($this->cart->contents());} ;?>
                    ...
                    <?php  $totalqty=0;
                        ...
                        <p><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo $itemtotal+$calvat+$servicecharge-$discount;?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></p>
                        </li>
                    </ul>
                    <?php } ?>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                		<div class="form-group row mb-0">
                            <label for="table" class="col-6 col-form-label"><?php echo display('table') ?></label>
                            <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="grandtotal" name="grandtotal" value="<?php echo $totalamount+$calvat+$servicecharge-$discount;?>">
                        </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="check_order" style="padding-bottom: 65px;">
                        ...
                        <input class="btn btn-success btn-block" style="border:none; height:50px;" name="" type="submit" value="><?php echo display('placeorder') ?>" />
                        </div>
                        </div>
                        </div>
                        </div>
