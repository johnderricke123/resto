        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12" id="mycartlist">
                    <h6 class="cart_heading" style="margin-bottom:0;"><?php echo display('view_ord') ?></h6>
                    ...
                    <ul class="list-unstyled cart_list">
                        ...
                        <p><?php if($currency->position==1){echo $currency->curr_icon;}?>  <?php echo $billinfo->service_charge; ?> <?php if($currency->position==2){echo $currency->curr_icon;}?></p>
                        </li>
