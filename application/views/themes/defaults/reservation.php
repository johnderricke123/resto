            ...
            <div class="row table_chart_inner py-5">
                <div class="col-md-4 col-sm-6 text-center mb-3">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                        <img src="<?php echo base_url();?>application/views/themes/<?php echo $acthemename; ?>/assets_web/images/reservation/1.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 text-center mb-3">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                        <img src="<?php echo base_url();?>application/views/themes/<?php echo $acthemename; ?>/assets_web/images/reservation/8.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 text-center mb-3">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                        <img src="<?php echo base_url();?>application/views/themes/<?php echo $acthemename; ?>/assets_web/images/reservation/3.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 text-center mb-3">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                        <img src="<?php echo base_url();?>application/views/themes/<?php echo $acthemename; ?>/assets_web/images/reservation/2.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 text-center mb-3">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                        <img src="<?php echo base_url();?>application/views/themes/<?php echo $acthemename; ?>/assets_web/images/reservation/6.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 text-center mb-3">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                ...
                <div class="col-md-4 col-sm-6 text-center mb-3 mb-md-0">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                        <img src="<?php echo base_url();?>application/views/themes/<?php echo $acthemename; ?>/assets_web/images/reservation/7.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 text-center">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
                        <img src="<?php echo base_url();?>application/views/themes/<?php echo $acthemename; ?>/assets_web/images/reservation/4.png" class="img-fluid" alt="">
                    </a>
                </div>
                <div class="col-md-4 col-sm-6 text-center">
                    <a href="#" data-toggle="modal" data-target="#bookinfo">
