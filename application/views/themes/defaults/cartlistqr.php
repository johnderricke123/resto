...
if(!empty($this->cart->contents())){ $totalqty= count($this->cart->contents());} ;?>
					...
					<?php  $totalqty=0;
                        ...
                        <p><?php if($this->storecurrency->position==1){echo $this->storecurrency->curr_icon;}?><?php echo $totalamount+$calvat+$servicecharge-$discount;?><?php if($this->storecurrency->position==2){echo $this->storecurrency->curr_icon;}?></p>
                        </li>
                    </ul>