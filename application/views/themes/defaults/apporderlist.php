...
.text-nowrap{border:none;display: inline-table;}
    </style>
 ...
 <div class="modal fade" id="vieworder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="product_sec sec_mar only-sm">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                	<center style="text-align: center; font-size: 25px"><?php echo display('morderlist') ?></center>
          <table class="table datatable2 table-fixed table-bordered table-hover bg-white table-responsive text-nowrap" id="purchaseTable">
                                <thead>
                                     <tr>   <th class="text-center"><?php echo display('status') ?></th> 
								...
								foreach($iteminfo as $item){
                                	...
                                	<tr>
                                        ...
                                        <?php if($item->order_status==1){echo display('pending_ord');}
										if($item->order_status==2){echo display('Processingod');}
										if($item->order_status==3){echo display('ready');}
										if($item->order_status==4 && $item->orderacceptreject!=1){echo display('pending_ord');}
										if($item->order_status==4 && $item->orderacceptreject==1){echo display('served');}
										//if($item->order_status==4){echo "Served";}
										if($item->order_status==5){echo display('cancel');}
										 ?>
                                       </td>
                                    	...
                                    	<td class="text-center">
                                         <a onclick="vieworderinfo(<?php echo $item->order_id;?>)"  class="btn btn-xs btn-success" data-toggle="modal" data-target="#vieworder" style="color: #fff;" data-dismiss="modal"><?php echo display('view') ?></a>
