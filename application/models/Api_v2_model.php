...
public function customerorder($customerid){
	...
	public function customerfoodlist($oredrid){
		/*$this->db->select('order_menu.*,item_foods.ProductsID,item_foods.ProductName,item_foods.ProductImage,variant.variantid,variant.variantName,variant.price');
        $this->db->from('order_menu');
		$this->db->join('item_foods','item_foods.ProductsID=order_menu.menu_id','left');
		$this->db->join('variant','item_foods.ProductsID=variant.menuid','inner');*/
